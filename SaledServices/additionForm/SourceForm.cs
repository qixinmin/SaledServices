...
namespace SaledServices
{
    public partial class SourceForm : Form
    {
        ...
        {
            if (this.sourceTextBox.Text.Trim() == "")
            {
            ...
            try
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    ...
                    cmd.Connection = conn;
                    cmd.CommandText = "INSERT INTO " + tableName + " VALUES('" + this.sourceTextBox.Text.Trim() + "')";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            this.sourceTextBox.Text = dataGridView1.SelectedCells[1].Value.ToString();
