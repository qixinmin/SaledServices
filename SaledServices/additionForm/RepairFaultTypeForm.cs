...
namespace SaledServices.additionForm
{
    public partial class RepairFaultTypeForm : Form
    {
        ...
        private String tableName = "repairFaultType";
        ...
        {
            if (this.faultTypeTextBox.Text.Trim() == "")
            {
                MessageBox.Show("故障的内容为空!");
                return;
            }
            ...
            try
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    ...
                    cmd.Connection = conn;
                    cmd.CommandText = "INSERT INTO " + tableName + " VALUES('" + this.faultTypeTextBox.Text.Trim() + "')";
