...
{
    public partial class QueryAllInfoFormForRepair : Form
    {
        private SqlConnection mConn;
        private DataSet ds;
        private SqlDataAdapter sda;

        public QueryAllInfoFormForRepair()
        {
            InitializeComponent();
        ...
        private void vendor_serial_no_textBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == System.Convert.ToChar(13))
            {
                if (this.vendor_serial_no_textBox.Text.Trim() == "")
                {
                    ...
                    MessageBox.Show("vendor内容为空，请检查！");
                    return;
                }
