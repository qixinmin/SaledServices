    ...
    public partial class BgaWaitMaterialExport : Form
    {
        ...
        private void exportxmlbutton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                "vendor_serail_no,mpn,mb_make_date,customFault,ECO,bgatype,BGAPN,BGA_describe,bga_brief,inputer,input_date from bga_wait_material_record_table where status ='' and input_date between '" + startTime + "' and '" + endTime + "'";
