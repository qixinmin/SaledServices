...
{
    public partial class StoreFruOutExport : Form
    {
        public StoreFruOutExport()
        {
            InitializeComponent();
        }
        ...
        private void exportxmlbutton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select *  from fru_smt_out_stock where input_date between '" + startTime + "' and '" + endTime + "'";
