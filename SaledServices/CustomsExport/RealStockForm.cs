    ...
    public partial class RealStockForm : Form
    {
        ...
        private void exportxmlbutton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select mpn,stock_in_num,input_date,stock_place from fru_smt_in_stock where isdeclare='是'  and order_receive_date between '" + DateTime.Now.ToString("yyyy/MM/dd") + "' and '" + DateTime.Now.ToString("yyyy/MM/dd")+"'";
                querySdr = cmd.ExecuteReader();
