...
{
    public partial class SMT_OutSheetForm : Form
    {
       ...
       // private string requestNumber = "";
        ...
        private void loadInformation()
        {
            try
            {
                ...
                cmd.CommandText = "select distinct vendor from fru_smt_in_stock where material_type in ('SMT')";
                ...
                cmd.CommandText = "select distinct product from fru_smt_in_stock where material_type in ('SMT')";
            ...
            try
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    ...
                    cmd.CommandText = "INSERT INTO " + tableName + " VALUES('" +
                        ...
                        this.mb_query_describeBox.Text.Trim() + "','" +
        ...
        private void clearInput()
        {
            ...
            this.mb_query_describeBox.Text = "";
        ...
        private void query_Click(object sender, EventArgs e)
        {
            ...
            string[] hTxt = { "ID", "厂商", "采购类别", "客户别", "材料大类", "MPN", "MB简称", "材料名称", "厂商料号", "描述", "出库数量", "单价", "库位", "领用人", "出库人", "用途", "备注", "出库日期"};
        ...
        private void modify_Click(object sender, EventArgs e)
        {
            ...
            dr["mb_brief"]= this.mb_query_describeBox.Text.Trim();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            this.mb_query_describeBox.Text = dataGridView1.SelectedCells[6].Value.ToString();
            ...
            this.stock_out_numTextBox.Text= dataGridView1.SelectedCells[10].Value.ToString();
            this.pricePerTextBox.Text= dataGridView1.SelectedCells[11].Value.ToString();
   
            this.stock_placetextBox.Text= dataGridView1.SelectedCells[12].Value.ToString();
            this.takertextBox.Text= dataGridView1.SelectedCells[13].Value.ToString();
            this.inputerTextBox.Text= dataGridView1.SelectedCells[14].Value.ToString();
            this.use_describetextBox.Text = dataGridView1.SelectedCells[15].Value.ToString();
        ...
        public void doRequestUsingMpn()
        {
            ...
            try
            {
                ...
                if (conn.State == ConnectionState.Open)
                {
                    ...
                    cmd.CommandText = "select vendor,product,mb_brief,describe,material_type,vendormaterialNo,material_name  from fru_smt_in_stock where mpn='" + this.mpnTextBox.Text.Trim() + "'";
                    querySdr = cmd.ExecuteReader();
                    ...
                    while (querySdr.Read())
                    {
                        ...
                        this.mb_query_describeBox.Text = querySdr[2].ToString();
        ...
        private void queryStock_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                List<useClass2> list = new List<useClass2>();
                string sql = "select mpn,stock_place,stock_in_num,vendor,product,describe from fru_smt_in_stock where material_type='SMT'";
                ...
                if (this.mb_query_describeBox.Text != "")
                {
                    sql += " and describe like '%" + this.mb_query_describeBox.Text + "%'";
                }
                ...
                while (querySdr.Read())
                {
                    useClass2 useclass = new useClass2();
                    string mpn = querySdr[0].ToString();
                    
                    bool exist = false;
                    foreach(useClass2 temp in list)
                    {
                        if(temp.mpn == mpn)
                        {
                            exist = true;
                    ...
                    useclass.product = querySdr[4].ToString();
                    useclass.describe = querySdr[5].ToString();
                    list.Add(useclass);                       
                }
                querySdr.Close();
                ...
                string[] hTxt = { "MPN", "库位", "已有数量", "厂商","客户别","描述" };
                for (int i = 0; i < hTxt.Length; i++)
                {
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            this.vendorcomboBox.Text = dataGridView2.SelectedCells[3].Value.ToString();
            this.productcomboBox.Text = dataGridView2.SelectedCells[4].Value.ToString();
            doRequestUsingMpn();
        }
